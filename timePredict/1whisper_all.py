...
class SpeechRecognitionTool:
    def __init__(self, whisper_model_size="base"):
        ...
        self.model_path = "model/whisper_final.pkl"  # 这个将用于存储合并后的模型
        ...
        self.model_trainer = ModelTrainer(
            ...
            target_column="execution_time",  # 改为预测总执行时间
    ...
    def train_model(self):
        ...
        # 计算新的目标变量：process_time + execution_time
        df['total_time'] = df['process_time'] + df['execution_time']
    ...
    def predict_total_time(self, duration: float, audio_entropy: float = 0.0, 
        ...
        """预测总执行时间（process_time + execution_time）"""
...
def main():
    ...
    if predicted_total_time is not None:
        print(f"Predicted Total Time: {predicted_total_time} seconds")
